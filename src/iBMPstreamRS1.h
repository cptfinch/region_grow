...
The read() mathod of this class returns the next pixel(s) of an inflated stream.  To a user of this class, the source file is read as a stream of uncompressed rgb pixel values.
